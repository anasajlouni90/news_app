...
class _HomeState extends State<Home> {
  ...
  void initState() {
    super.initState();
    getTopHeadlinesBloc..getHeadlines(widget.language);
  }

  Future<void> _refresh() async {
    await getTopHeadlinesBloc
      ..getHeadlines(widget.language);
  }
    ...
    return StreamBuilder<ArticleResponse>(
      ...
      builder: (context, AsyncSnapshot<ArticleResponse> snapshot) {
        if (snapshot.hasData) {
          ...
          return _buildHeadLinesWidget(snapshot.data);
  ...
  Widget _buildHeadLinesWidget(ArticleResponse data) {
