...
class CategoryNewsHealth extends StatefulWidget {
  final language;
  CategoryNewsHealth({this.language});

  @override
  _CategoryNewsHealthState createState() => _CategoryNewsHealthState();
}

class _CategoryNewsHealthState extends State<CategoryNewsHealth> {
  @override
  void initState() {
    super.initState();
    getCategoryNewsClassBloc..getCategoryNewsHealth(widget.language);
  }

  Future<void> _refresh() async {
    await getCategoryNewsClassBloc
      ..getCategoryNewsHealth(widget.language);
  }
