...
class CategoryNewsBusiness extends StatefulWidget {
  final language;
  CategoryNewsBusiness({this.language});

  @override
  _CategoryNewsBusinessState createState() => _CategoryNewsBusinessState();
}

class _CategoryNewsBusinessState extends State<CategoryNewsBusiness> {
  @override
  void initState() {
    super.initState();
    getCategoryNewsClassBloc..getCategoryNewsBusiness(widget.language);
  }

  Future<void> _refresh() async {
    await getCategoryNewsClassBloc
      ..getCategoryNewsBusiness(widget.language);
  }
