...
class CategoryNewsTechnology extends StatefulWidget {
  final language;
  CategoryNewsTechnology({this.language});

  @override
  _CategoryNewsTechnologyState createState() => _CategoryNewsTechnologyState();
}

class _CategoryNewsTechnologyState extends State<CategoryNewsTechnology> {
  @override
  void initState() {
    super.initState();
    getCategoryNewsClassBloc..getCategoryNewsTechnology(widget.language);
  }

  Future<void> _refresh() async {
    await getCategoryNewsClassBloc
      ..getCategoryNewsTechnology(widget.language);
  }
