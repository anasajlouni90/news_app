...
class CategoryNewsSports extends StatefulWidget {
  final language;
  CategoryNewsSports({this.language});

  @override
  _CategoryNewsSportsState createState() => _CategoryNewsSportsState();
}

class _CategoryNewsSportsState extends State<CategoryNewsSports> {
  @override
  void initState() {
    super.initState();
    getCategoryNewsClassBloc..getCategoryNewsSports(widget.language);
  }

  Future<void> _refresh() async {
    await getCategoryNewsClassBloc
      ..getCategoryNewsSports(widget.language);
  }
