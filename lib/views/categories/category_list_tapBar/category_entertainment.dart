...
class CategoryNewsEntertainment extends StatefulWidget {
  final language;
  CategoryNewsEntertainment({this.language});

  @override
  _CategoryNewsEntertainmentState createState() =>
      _CategoryNewsEntertainmentState();
}

class _CategoryNewsEntertainmentState extends State<CategoryNewsEntertainment> {
  @override
  void initState() {
    super.initState();
    getCategoryNewsClassBloc..getCategoryNewsEntertainment(widget.language);
  }

  Future<void> _refresh() async {
    await getCategoryNewsClassBloc
      ..getCategoryNewsEntertainment(widget.language);
  }
