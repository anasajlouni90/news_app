...
class CategoryNewsGeneral extends StatefulWidget {
  final String category;
  final language;
  CategoryNewsGeneral({this.category, this.language});

  @override
  _CategoryNewsGeneralState createState() => _CategoryNewsGeneralState();
}

class _CategoryNewsGeneralState extends State<CategoryNewsGeneral> {
  @override
  void initState() {
    super.initState();
    getHotNewsBloc..getHotNews(widget.language);
  }

  Future<void> _refresh() async {
    await getHotNewsBloc
      ..getHotNews(widget.language);
  }
